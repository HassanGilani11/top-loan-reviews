...
add_shortcode('shortcode_post_rating', 'get_star_rating');

function get_star_rating() {
    // Fetch the rating from a custom field
    $rating = get_field('rating');

    // Check if the rating is set
    if ($rating) {
        // Calculate the average stars (scale 0-5)
        $average_stars = round($rating * 2) / 2;
        $drawn = 5;

        // Start the star rating container
    ...
    return ''; // Return an empty string if no rating
}
