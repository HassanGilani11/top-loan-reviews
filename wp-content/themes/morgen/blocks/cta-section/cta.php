...
$button_form_id_card_3 = get_field( 'button_form_id_card_3' );
...
$button_url_card_3 = $button_url_card_3 ? $button_url_card_3 : 'cta-form-modal-popup';
    ...
    <div class="row">
        <div class="col-md-4 px-0 col-sm-12">
            <div class="card" style="background-color: <?php echo (!empty($background_color_card_1) ? $background_color_card_1 : "#D7E6FF"); ?>">
                <div class="card-body">
                    ...
                    <div class="cta-btn">
                    <a class="animate-scroll animated-btn" href="<?php echo (!empty($button_url_card_1) ? $button_url_card_1 : "#"); ?>"><?php echo $button_text_card_1; ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card" style="background-color: <?php echo (!empty($background_color_card_1) ? $background_color_card_2 : "#D7E6FF"); ?>">
                <div class="card-body">
                    ...
                    <div class="cta-btn">
                    <a class="animate-scroll animated-btn" href="<?php echo (!empty($button_url_card_2) ? $button_url_card_2 : "#"); ?>"><?php echo $button_text_card_2; ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card" style="background-color: <?php echo (!empty($background_color_card_1) ? $background_color_card_3 : "#D7E6FF"); ?>">
                <div class="card-body">
                    ...
                    <div class="cta-btn">
                        <a class="animate-scroll animated-btn btn-subscribe" href="#<?php echo esc_attr( $button_url_card_3 ); ?>"><?php echo $button_text_card_3; ?></a>
                    </div>
                </div>
                <?php if( ! is_admin() ): ?>
                    <div id="<?php echo esc_attr( $button_url_card_3 ); ?>" class="cta-form-modal-modal-wrapper white-popup mfp-hide">
                        <button class="popup-modal-dismiss">X</button>
                        <?php echo do_shortcode('[gravityform id="'. (int)$button_form_id_card_3 .'" title="false" description="false" ajax="true" tabindex="49"]'); ?>
                    </div>
                <?php endif ?>
            </div>
        </div>
